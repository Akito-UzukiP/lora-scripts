...
parser.add_argument("--port", type=int, default=6007, help="Port to run the server on")
...
parser.add_argument("--tensorboard-port", type=int, default=6008, help="Port to run the tensorboard")
